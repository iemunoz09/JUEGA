...
<html lang="en">
	...
	<body>	
		...
		<div id="formContainer" class="d-flex align-content-center">
			<form class="form-playerInfo" id="pForm" name="pForm" method="post" action=" ">
				...
				<div class="my-3">				
					<button class="btn btn-outline-info btn-block" id="plusToMinus" type="button" data-toggle="collapse" data-target="#optDiv" aria-expanded="false" aria-controls="optDiv"><b>+</b></button>
